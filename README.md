...
ele não disponibiliza o código para copiar e colar e a pessoa alterar, tive que capturar tudo 
através do próprio vídeo, ai dexei aqui mais fácil para edição de quem quiser...A idéia dele 
é muito boa e eu precisava para ajudar minha esposa no estágio dela no processo de cobranças 
enviadas por e-mail isso ajudou muito nesse processo, assim ela ganhou destaque, e eu ganhei mais clientes!

## A MONTAGEM DO SISTEMA -

* Você vai precisar de uma VPS com n8n rodando ou um self-host como eu.
* Hospedagem na própria VPS ou aqui mesmo no Github, para qualquer pessoa como link acessar o sistema de cobranças.
* Criar uma planilha no google sheet (planilhas)
